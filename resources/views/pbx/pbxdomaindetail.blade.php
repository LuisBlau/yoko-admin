        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-3">
                    <div class="panel panel-filled">
                        <div class="panel-body">
                            <div class="small">Number of DID's</div>
                ...
                <div class="col-3">
                    <div class="panel panel-filled">
                        <div class="panel-body">
                            <div class="small">Number of DID's W/SMS</div>
                ...
                <div class="col-3">
                    <div class="panel panel-filled">
                        <div class="panel-body">
                            ...
                            <h2 class="m-b-none server2">{{$usercount}}</h2>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="panel panel-filled">
                        ...
                        <table class="table table-responsive-sm" id="maintable">
                                ...
                                <tr>
                                    ...
                                    <td><button class="btn btn-default btn-xs" data-toggle="modal" data-target="#history_modal" onclick="setpn(this);"><i class="pe-7s-chat"></i></button></td>
                                </tr>
                                @endforeach
                                </tbody>
                            </table>
