...
class PbxController extends Controller
{
    ...
    public function sendSmsMms(Request $request)
    {
        /*
        API for the purpose of receiving a request from the PBX to send a SMS or MMS.
        
        {
        "from": "+16305191110",
        "to": ["+18014251023"],
        "applicationId": "yokonetworks",
        "text": "sd"
        }

        The first step you will need to do is save this request in the message_logs table. The field to value should be like the following:

        inbound = 0
        from = from
        recipients = to
        text = text
        carrier = "Peerless" <--- This is hard coded for now. We will update this logic later
        */
